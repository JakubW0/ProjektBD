...
public class AdministratorController implements Initializable {
  ...
  @FXML
    ...
    tPrzedmioty.setDodaj(idDodaj.getText(), jed.getText(), dwa.getText(), trzy.getText(), czt.getText());
            System.out.println(czt.getText());
    table.setItems(tPrzedmioty.getOblist());
      combo.setItems(comboWriter());
        }
            ...
            tGrupa.setDodaj(idDodaj.getText(),jed.getText());
            tableGrupa.setItems(tGrupa.getOblist());
            combo.setItems(comboWriterU());
        }
        else if(tab.getTab() == 2){
            System.out.println(tProwadzacy.getOblist().size()+1);
            tProwadzacy.setDodaj(idDodaj.getText(),jed.getText(),dwa.getText(),trzy.getText(),czt.getText(),pie.getText(),sze.getText(),sie.getText());
            tableProwadzacy.setItems(tProwadzacy.getOblist());
            combo.setItems(comboWriterU());
        }
        else if(tab.getTab() == 3){
            System.out.println(tStudenci.getOblist().size()+1);
            tStudenci.setDodaj(idDodaj.getText(),jed.getText(),dwa.getText(),trzy.getText(),czt.getText(),pie.getText(),sze.getText(),sie.getText(),osi.getText(),dzie.getText(),dzies.getText(),jede.getText());
            tableStudenci.setItems(tStudenci.getOblist());
            combo.setItems(comboWriterU());
        }
          ...
          tablePlan.setItems(tPLan.getOblist());
            ...
            tTypy.setDodaj(idDodaj.getText(),jed.getText());
            tableTyp.setItems(tTypy.getOblist());
            combo.setItems(comboWriterU());
        }
        else if(tab.getTab() == 11){
            System.out.println(tTytul.getOblist().size()+1);
            tTytul.setDodaj(idDodaj.getText(),jed.getText());
            tableTytul.setItems(tTytul.getOblist());
            combo.setItems(comboWriterU());
        }
  ...
  @FXML
    ...
    private void onAktualizuj(){
        ...
        if(tab.getTab() == 0) {
            ...
            tStudenci.setAktualizuj(combo.getValue(), jed.getText(), dwa.getText(), trzy.getText(), czt.getText(),pie.getText(),sze.getText(),sie.getText(),osi.getText(),dzie.getText(),dzies.getText(),jede.getText());
            ...
            tTypy.setAktualizuj(combo.getValue(), jed.getText());

            tableTyp.setItems(tTypy.getOblist());
            combo.setItems(comboWriterU());
        }
        else if(tab.getTab() == 11){
            tTytul.setAktualizuj(combo.getValue(), jed.getText());
    ...
    private void onTab(){
        if(getIndex() == 0){
           ...
           trzy.setPromptText("Ects");
           czt.setPromptText("Godziny");
