...
public class TableStudenci {
    ...
    public void setDodaj( String idprzedS, String spec,String tryb, String kierunek, String semestr ,String grupa, String album, String imie, String nazwisko ,String data, String pesel, String stypendium ){
    ...
    public void setAktualizuj( String idprzedS, String idtypS, String nazwaS ,String ectsS, String godzinyS, String grupaS, String albumS, String imieS, String nazwiskoS, String dataS, String peselS, String stypendiumS){

        oblistStudenci.clear();
        try {
            Connection conn = ConnectTable.connectdb();
            conn.createStatement().executeUpdate("UPDATE `studenci` SET `id_specjalnosc`='"+idtypS+"',`Id_tryb`= '"+nazwaS+"',`id_kierunek`='"+ectsS+"',`id_semestr`='"+godzinyS+"',`id_grupy`='"+grupaS+"',`nr_albumu`='"+albumS+"',`imie_studenta`='"+imieS+"',`nazwisko_studenta`='"+nazwiskoS+"' ,`data_urodzenia_student`='"+dataS+"' ,`pesel_student`='"+peselS+"',`stypendium`='"+stypendiumS+"'  WHERE `Id_student`='"+idprzedS+"'");
            ResultSet rs = conn.createStatement().executeQuery("SELECT * FROM `studenci`");
            while (rs.next()) {
                oblistStudenci.add(new ModelStudenci(rs.getString("id_student"),
                        rs.getString("id_specjalnosc"),
